# OIM3640 Problem Solving & Software Design  - Term Project - 2024 Fall

---

## 1. Overview

From now until the end of the semester, you will work individually or in a team of two on a group software project. The final submission is due on **Tuesday, 12/03.** Please carefully review the detailed deliverable requirements outlined below.
...
- A good project should align with your personal learning goals. For example:
  - If you are interested in learning **web aplication development**, you might want to build a web application using frameworks like **Flask** or **FastAPI**. This can help you gain hands-on experience with back-end development, routing, and API creation.
...
- Due: 12/03
- The final website (or README) is worth **10%** of the project grade.
...
As part of your code development process, GenAI tools can be a great resource for debugging, reviewing code, suggesting improvements, or even generating small code snippets. While your project should be your own, leveraging AI to enhance productivity and solve specific problems can be beneficial, especially for repetitive or boilerplate tasks.

However, if you use AI to generate any part of your code, you must provide proper attribution and clearly reference that the code was AI-assisted. Additionally, make sure you fully understand any code generated by AI. You may be asked to explain the code during the project evaluation to demonstrate your understanding and how it fits into the overall project structure.
