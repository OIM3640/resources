# OIM3640 Problem Solving & Software Design  - Term Project - 2025 Fall

---

## 1. Overview

From now until the end of the semester, you will work individually or in a team of two on a group software project. The final submission is due on **12/05**. Please carefully review the detailed deliverable requirements outlined below.
...
- Due: 11/12
- The project proposal is worth **5%** of the project grade.
...
- Create a `proposal.md` file in your repository (you'll complete and submit this by 11/14).
- Schedule a meeting with the professor, or communicate via email, to discuss potential project ideas before the next deadline.
...
- Due: 11/14
- The project proposal is worth **15%** of the project grade.

Your proposal should be written in a file named **`proposal.md`** in the root of your project's GitHub repository.
...
The proposal must be written using [markdown format](https://docs.github.com/en/get-started/writing-on-github/getting-started-with-writing-and-formatting-on-github/basic-writing-and-formatting-syntax). We recommend checking out [markdown-it demo](https://markdown-it.github.io) if you need more help with markdown syntax. You need to commit and push `proposal.md` to your project's GitHub repository, and **everyone on the team must submit the URL of the proposal (e.g., `https://github.com/username/project-name/blob/main/proposal.md`) to Canvas for grading purposes**.
...
Although it is optional for this project, proper documentation is essential to your final product. It would be best to generate documentation from the docstrings, and you can do this using tools such as [pydoc](https://docs.python.org/3.14/library/pydoc.html). If you want to generate truly beautiful documentation, check out [Read the Docs](https://readthedocs.org/) and [Sphinx](https://www.sphinx-doc.org/en/master/) (the tool used to generate the Python documentation).
